...
function App() {
  ...
  return (
    <div className="App py-5 px-5">
      ...
      >
        <p className="px-3">This is modal content</p>
      </Modal>
      <h3 className="mt-3">Alert</h3>
      <Alert onclick={clickShowCloseXAlert} type={"warning"} show={showXAlert}
             onDismiss={clickCloseXAlert}>{"This is a warning type alert"}</Alert>
